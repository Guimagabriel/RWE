...
@section('content')
    <form action="{{ route('users.update', ['user' => $user->id]) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="row mb-3 m-3">
            <h1 id="titulo">Edição de Usuário</h1>
        </div>
        <div class="row mb-3 m-3">
            <label for="name" class="col-sm-2 m-1 col-form-label">*Nome:</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="name" id="name" style="width: 35em;" value="{{ $user->name }}">
        ...
        <div class="row mb-3 m-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="email" id="email" style="width: 35em;" value="{{ $user->email }}">
            ...
            <div class="col-sm-10">
                ...
                <span class="input-group-text" id="basic-addon1">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                    ...
                    @php($socialNetworkArray = json_decode($user->social_network, true))
                    <input type="text" class="form-control" name="social_network[facebook]" id="facebook" value="{{ $socialNetworkArray['facebook'] }}" placeholder="Facebook">
                ...
                <span class="input-group-text" id="basic-addon1">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
                    ...
                    <input type="text" class="form-control" name="social_network[twitter]" id="twitter" value="{{ $socialNetworkArray['twitter'] }}" placeholder="Twitter">
                ...
                <span class="input-group-text" id="basic-addon1">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                    ...
                    <input type="text" class="form-control" name="social_network[instagram]" id="instagram"  value="{{ $socialNetworkArray['instagram'] }}" placeholder="Instagram">
                ...
                <span class="input-group-text" id="basic-addon1">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
                    ...
                    <input type="text" class="form-control" name="social_network[linkedin]" id="linkedin" value="{{ $socialNetworkArray['linkedin'] }}" placeholder="Linkedin">
        ...
        <div class="row mb-3 m-3">
            ...
            <div class="col-sm-10">
                <textarea name="about" class="form-control" id="about" placeholder="Fala um pouco sobre você..." cols="40" rows="6">{{ $user->about }}</textarea>
            </div>
        </div>
